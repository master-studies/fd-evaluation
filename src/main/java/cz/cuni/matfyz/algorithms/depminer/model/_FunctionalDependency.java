...
public class _FunctionalDependency {
    ...
    public static class _ColumnIdentifier implements Comparable<_ColumnIdentifier>, Serializable {
        ...
        /**
         * Returns the encoded string for this column identifier. The encoded
         * string is determined by the given mappings.
         *
        ...
        /**
         * Creates a ColumnIdentifier from the given string using the given
         * mappings.
         *
         * @param tableMapping the table mapping
         * @param columnMapping the column mapping
    ...
    public static class _ColumnCombination implements Serializable, Comparable<Object> {
        ...
        /**
         * Creates a column combination from the given string using the given
         * mapping.
         *
         * @param tableMapping the table mapping
         * @param columnMapping the column mapping
...
//	}
     ...
     */
    public static _FunctionalDependency fromString(Map<String, String> tableMapping, Map<String, String> columnMapping, String str)
            throws NullPointerException, IndexOutOfBoundsException {
        ...
        return new _FunctionalDependency(determinant, dependant);
    }
    ...
    public boolean equals(Object obj) {
        ...
        _FunctionalDependency other = (_FunctionalDependency) obj;
        if (dependant == null) {
